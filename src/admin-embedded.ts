...
import A_0_assets_index_CnRu7vXb_js from '../admin/dist/assets/index-CnRu7vXb.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-CnRu7vXb.js": { path: A_0_assets_index_CnRu7vXb_js as unknown as string, mime: "application/javascript; charset=utf-8" },

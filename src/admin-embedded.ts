...
import A_0_assets_index_DC7temeT_js from '../admin/dist/assets/index-DC7temeT.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_hsAAIwgt_css from '../admin/dist/assets/index-hsAAIwgt.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-DC7temeT.js": { path: A_0_assets_index_DC7temeT_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-hsAAIwgt.css": { path: A_1_assets_index_hsAAIwgt_css as unknown as string, mime: "text/css; charset=utf-8" },
